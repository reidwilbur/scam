...
object Command {
  class QuietCommandException(msg: String = null, cause: Throwable = null) extends RuntimeException(msg, cause)
  class DefaultResponseException(msg: String = null, cause: Throwable = null) extends RuntimeException(msg, cause)
  ...
  implicit def toBytes(cmd: Command): Array[Byte] = {
    ...
    val bytes = ByteBuffer.allocate(cmd.headerLen + bodyLen)
